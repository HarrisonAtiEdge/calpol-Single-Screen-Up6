...
teams.forEach(team => {
 ...
 // ****************Timer 👆******************
    ...
    const questions = [
        {
            question: "Q1. Taking 1 or 2 extra tablets by accident is unlikely to be harmful, as long as you do not take more than 8 tablets in 24 hours",
            options: ["False", "True"],
            correctOption: 1,
        ...
        {
            question: "Q2. Paracetamol reaches peak plasma concentration _____ times faster than Ibuprofen",
            options: ["6x", "4x", "2x", "3x"],
            correctOption: 0,
        ...
        {
            question: "Q3. Calpol starts action on fever in",
            options: ["120 minutes", "60 minutes", "30 minutes", "15 minutes"],
            correctOption: 3,
            images: ["../images/sonic.webp","../images/sonic.webp","../images/sonic.webp","../images/sonic.webp"],
            ref:  "Ref:	Senel S;Indian J Pediatr;2011;1-6.",
            optionLabels : ['A', 'B', 'C', 'D']
        }
