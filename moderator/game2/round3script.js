...
teams.forEach(team => {
 ...
 // ****************Timer 👆******************
    ...
    const questions = [
        {
            question: "Q1. Paracetamol is readily absorbed from the gastrointestinal tract and peak plasma concentrations occur about _____ after oral doses",
            options: ["10 to 60 minutes", "60 to 90 minutes", "90 to 120 minutes"],
            correctOption: 0,
            images: ["../images/sonic.webp","../images/sonic.webp","../images/sonic.webp"],
            ref:  "Ref:	Martindale;The Complete Drug Reference;2020;36 Edition",
            optionLabels : ['A', 'B', 'C', 'D']
        },
        {
            question: "Q2. Ibuprofen is absorbed from the gastrointestinal tract and peak plasma concentrations occur about _____ after ingestion",
            options: ["4 to 5 hours ", "3 to 4 hours", "2 to 3 hours", "1 to 2 hours"],
            correctOption: 3,
        ...
        {
            question: "Q3. Mefanamic acid is absorbed from the gastrointestinal tract and peak plasma concentrations occur about _____ after ingestion",
            options: ["1 to 2 hours", "2 to 4 hours", "3 to 4 hours", "4 to 5 hours"],
            correctOption: 1,
            images: ["../images/sonic.webp","../images/sonic.webp","../images/sonic.webp","../images/sonic.webp"],
            ref:  "Ref:	Martindale;The Complete Drug Reference;2020;36 Edition",
            optionLabels : ['A', 'B', 'C', 'D']
