...
teams.forEach(team => {
 ...
 // ****************Timer 👆******************
    ...
    const questions = [
        {
            question: "Q1. Though ibuprofen at a dose of 10 mg/kg has similar efficacy as paracetamol in reducing fever, it has more side effects.",
            options: ["False", "True"],
            correctOption: 1,
        ...
        {
            question: "Q2. Adult can take a maximum of 4 doses (up to eight 500 mg tablets in total) in 24 hours",
            options: ["True", "False"],
            correctOption: 0,
            images: ["../images/sonic.webp","../images/sonic.webp"],
        ...
        {
            question: "Q3. Wait at least ____ hours between paracetamol doses",
            options: ["3", "4", "5", "6"],
            correctOption: 1,
