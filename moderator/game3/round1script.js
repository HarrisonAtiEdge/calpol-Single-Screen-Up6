...
teams.forEach(team => {
 ...
 // ****************Timer 👆******************
    ...
    const questions = [
        {
            question: "Q1. More than _______ of trust on Calpol established efficacy and safety.",
            options: ["40 years", "30 years", "50 years", "60 years"],
            correctOption: 0,
            images: ["../images/sonic.webp","../images/sonic.webp","../images/sonic.webp","../images/sonic.webp"],
            ref:  "Ref:	Registration Letter- Calpol Suspension;1976;1-3",
            optionLabels : ['A', 'B', 'C', 'D']
        },
        {
            question: "Q2. Fever is the most common presenting symptom of pediatric illnesses",
            options: ["False", "True"],
            correctOption: 1,
            images: ["../images/sonic.webp","../images/sonic.webp"],
            ref:  "Ref: TECHNOLOGY LANDSCAPE;2018;1-154",
            optionLabels : ['A', 'B', 'C', 'D']
        },
        {
            question: "Q3. Each tablet of Calpol contains Paracetamol BP ______ mg.",
            options: ["200mg", "400mg", "250mg", "500mg"],
            correctOption: 3,
            images: ["../images/sonic.webp","../images/sonic.webp","../images/sonic.webp","../images/sonic.webp"],
            ref:  "Ref:	Calpol tablets datasheet; February 2023",
            optionLabels : ['A', 'B', 'C', 'D']
        },
        {
            question: "Q4. Each 5ml of viscous, suspension of Calpol Peads contains Paracetamol BP ______ mg.",
            options: ["125mg", "120mg", "150mg", "160mg"],
            correctOption: 1,
            images: ["../images/sonic.webp","../images/sonic.webp","../images/sonic.webp","../images/sonic.webp"],
            ref:  "Ref:	Calpol Suspension Datasheet; February 2023",
            optionLabels : ['A', 'B', 'C', 'D']
        },
        {
            question: "Q5. What is the color and flavor of Calpol pediatric suspension?.",
            options: ["Pink and Orange", "White and Strawberry", "Pink and Strawberry", "Off White and Strawberry"],
            correctOption: 2,
            images: ["../images/sonic.webp","../images/sonic.webp","../images/sonic.webp","../images/sonic.webp"],
            ref:  "Ref:	Calpol Suspension Datasheet; February 2023",
            optionLabels : ['A', 'B', 'C', 'D']
        ...
        {
            question: "Q6. What is the recommended dosage of Calpol 6 PLUS suspension for children 6 to 12 years of age.",
            options: ["5-10ml", "20ml", "15ml", "25ml"],
            correctOption: 0,
            images: ["../images/sonic.webp","../images/sonic.webp","../images/sonic.webp","../images/sonic.webp"],
            ref:   "Ref:  Calpol 6 Plus Suspension Datasheet; February 2023",
            optionLabels : ['A', 'B', 'C', 'D']
        }
    ...
    var popupContainer2 = document.getElementById('popupContainer2');
        ...
        function handleOptionClick(event) {
            ...
            const currentQuestion = questions[currentQuestionIndex];
            const teamKey1 = `Game3 Table ${selectedTeam}`; // Construct team key
    ...
    // Event listener for the Reset Score button
     ...
     resetScoreBtn.addEventListener('click', function() {
         ...
         const keysToRemove = ['Game3 Table 1', 'Game3 Table 2', 'Game3 Table 3', 'Game3 Table 4', 'Game3 Table 5', 'Game3 Table 6', 'Game3 Table 7', 'Game3 Table 8',
         'Game3 Table 9', 'Game3 Table 10','Game3 Table 11', 'Game3 Table 12','Game3 Table 13', 'Game3 Table 14', 'Game3 Table 15', 'Game3 Table 16', 'Game3 Table 17', 'Game3 Table 18',
         'Game3 Table 19', 'Game3 Table 20','Game3 Table 21',];
