...
teams.forEach(team => {
 ...
 // ****************Timer 👆******************
    ...
    const questions = [
        {
            question: "Q1. What is the maximum daily dosage of Calpol 6 PLUS suspension for children 6 to 12 years of age.",
            options: ["30ml", "40ml", "50ml", "60ml"],
            correctOption: 1,
        ...
        {
            question: "Q2. What is the recommended dosage of Calpol paeds. Suspension for children 1 to under 6 years of age.",
            options: ["5 to 10 ml", "15 ml", "20 ml", "25 ml"],
            correctOption: 0,
            images: ["../images/sonic.webp","../images/sonic.webp","../images/sonic.webp","../images/sonic.webp"],
        ...
        {
            question: "Q3. What is the recommended dosage of Calpol paeds Suspension for children 2 to 3 month of age.",
            options: ["30mg/kg", "25mg/kg", "20mg/kg", "15mg/kg"],
            correctOption: 3,
            images: ["../images/sonic.webp","../images/sonic.webp","../images/sonic.webp","../images/sonic.webp"],
            ref: "Ref:	Calpol Suspension Datasheet; February 2023",
            optionLabels : ['A', 'B', 'C', 'D']
        ...
        {
            question: "Q4. Recommended dosage of Calpol paeds. Suspension is ml for 4 months to under 1 years.",
            options: ["6 ml ", "2 ml", "4 to 5 ml", "10 ml"],
            correctOption: 2,
            images: ["../images/sonic.webp","../images/sonic.webp","../images/sonic.webp","../images/sonic.webp"],
            ref:  "Ref:	Calpol Suspension Datasheet; February 2023",
            optionLabels : ['A', 'B', 'C', 'D']
        ...
        {
            question: "Q5. Being the most common cause of human illness, colds are responsible for significant absenteeism from school.",
            options: ["True", "False"],
            correctOption: 0,
            images: ["../images/sonic.webp","../images/sonic.webp"],
            ref:  "Ref:	Pappas DE;Principles and Practice of Pediatric Infectious Diseases;2018;199-202e1",
            optionLabels : ['A', 'B', 'C', 'D']
        },
        {
            question: "Q6. Symptoms of Influenza are Fever, Headache, Cough and Sore throat",
            options: ["False", "True"],
            correctOption: 1,
            images: ["../images/sonic.webp","../images/sonic.webp"],
